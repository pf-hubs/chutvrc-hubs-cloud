...
"@
    ...
    # =========================================================================
    Write-Header "Step 6: Select Deployment Template"
...
# =============================================================================
    ...
    # =========================================================================
    Write-Header "Step 8: Select Deployment Template"
    ...
    switch ($templateChoice) {
        "1" {
            Copy-Item "hcce-chutvrc.yam" "hcce.yam" -Force
            Write-Success "Chutvrc template selected"
        }
        "2" {
            Copy-Item "hcce-ce.yam" "hcce.yam" -Force
            Write-Success "Community Edition template selected"
        }
        default {
            Write-Warning2 "Invalid choice, defaulting to Chutvrc"
...
$renderContent = $renderContent -replace 'export HUB_DOMAIN="[^"]*"', "export HUB_DOMAIN=`"$HUB_DOMAIN`""
...
"@
        ...
        Write-Host ""
        Write-Host "cd '$scriptDir'" -ForegroundColor Yellow
        Write-Host "bash render_hcce.sh" -ForegroundColor Yellow
